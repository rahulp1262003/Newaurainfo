...
export default function AboutSection() {
    return (
        <section id="about" className="scroll-mt-[50px] py-16 bg-black text-white">
            <Helmet>
                <title>About Nexora Info Solution - Who We Are, Mission, Vision</title>
                ...
                <meta property="og:title" content="About Nexora Info Solution - Who We Are" />
            ...
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="space-y-6 relative">
                    ...
                    <div className="grid gap-6">
                        <div className="bg-zinc-800 p-4 rounded-xl shadow border border-gray-700">
