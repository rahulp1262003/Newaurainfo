        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between px-4">
                <div className="flex items-center">
                    <a href="/" aria-label="Nexora Home" className="flex items-center">
                        <img
                            src={Nexora}
                    ...
                    <div className="flex flex-col ml-2">
                        <a
                            href="/"
                            className="text-xl font-bold text-white max-md:text-[18px]"
                            aria-label="Nexora Info Solution Home"
                        >
                            Nexora
                        </a>
                        <span className="text-white max-md:text-[10px] text-sm">Info Solution</span>
                    </div>
                </div>
                ...
                <nav className="hidden md:flex" role="navigation" aria-label="Main menu">
                    {navLinks.map((link) => (
                        <a
                            ...
                            className="hover:text-black cursor-pointer rounded-xl transition-all duration-300 ease-in-out hover:bg-white px-5 py-2"
